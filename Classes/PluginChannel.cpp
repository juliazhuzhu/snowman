...
void PluginChannel::loadPlugins()
{
	...
	std::string appKey = "A5FACC99-90F9-D474-87A2-F900CEC896F1";
	std::string appSecret = "5b220d8ac2892c0b57c3c7e9c8b2b44f";
	std::string privateKey = "C48E4C350827E56E08172C06A7ABD141";
